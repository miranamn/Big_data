file:///C:/Users/gleba/flink-training-exercises/src/main/java/com/ververica/flinktraining/solutions/datastream_java/windows/HourlyTipsSolution.java
...
action parameters:
offset: 2768
uri: file:///C:/Users/gleba/flink-training-exercises/src/main/java/com/ververica/flinktraining/solutions/datastream_java/windows/HourlyTipsSolution.java
text:
```scala
/*
...
public class HourlyTipsSolution extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<TaxiFare> fares = env.addSo@@urce(fareSourceOrTest(new TaxiFareSource(input, maxEventDelay, servingSpeedFactor))).name("testname");
