 ...
 *  отфильтровать поток данных о поездках на такси, чтобы сохранить только те поездки, которые
 *  начинаются и заканчиваются в пределах Нью-Йорка. Полученный поток следует распечатать.
 *
 * Parameters:
...
public class RideCleansingExercise extends ExerciseBase {
	public static void main(String[] args) throws Exception {
		...
		// с лямбдой компактнее :)
		DataStream<TaxiRide> filteredRides = rides
				.filter((TaxiRide taxiRide) ->
